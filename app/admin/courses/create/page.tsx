...
import { courseCategories, courseLevels, CourseSchemaType, courseStatus } from "@/lib/zodSchemas";
        ...
        <>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Provide the basic information for the new course.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <Form {...form}>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className="w-full">
                                        ...
                                        <FormControl>
                                            <Textarea placeholder="Course Small Description"
